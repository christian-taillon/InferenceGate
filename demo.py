...
TEST_PROMPTS = [
    ...
    ("SECRET: JWT (Regex)", "Here is my token: eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTE2MjM5MDIyfQ.SflKxwRJSMeKKF2QT4fwpMeJf36POk6yJV_adQssw5c_FAKE"),
    ("SECRET: AWS KEY (Regex)", "AWS_ACCESS_KEY_ID=AKIA_FAKE_AWS_ACCESS_KEY_ID"),
